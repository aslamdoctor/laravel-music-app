...
<div class="mt-10 mb-5 flex justify-between items-center">
    ...
    <a href="/artists/create" class="inline-block px-3 py-1 rounded bg-green-700 hover:bg-green-800 text-white text-xs">Add New</a>
</div>
...
@if(count($artists))
    ...
    <div class="flex justify-content-start mb-3">
        <a href="/artists/{{ $artist->id }}" class="inline-block px-3 py-1 rounded bg-green-700 hover:bg-green-800 text-white text-xs mr-2">View</a>
        <a href="/artists/{{ $artist->id }}/edit" class="inline-block px-3 py-1 rounded bg-blue-700 hover:bg-blue-800 text-white text-xs mr-2">Edit</a>
